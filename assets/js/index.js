...
Swal.fire({
    title: 'Bienvenidos mi web!',
    text: '',
    html: `
            <p style:"font-size=8">Tener en cuenta las siguientes recomendaciones al ingresar los valores:</p>
            <hr>
            <strong>Ingreso de datos</strong>
            <hr>
            <ul style="list-style-type: none; ">
                <li>Para  decimales ingrese los valores en puntos <em> (2.3 - 1.2 <em>)</li>
           </ul> `,
